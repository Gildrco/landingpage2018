  ...
  class PP_CF7_Custom_Spinner_Admin {
    ...
    public function admin_notices( ) {
      ...
      if ( ! $this->_core->is_cf7_active() && get_current_screen()->id != $this->admin_handle ) {
        ...
        <div class="notice notice-error">
          <p><img src="<?php echo $this->_core->get_asset_file( 'img', '/pluginicon.png' ); ?>" style="width: 48px; height: 48px; float: left; margin-right: 20px" /><strong><?php _e( 'Error: The Contact Form 7 Custom Spinner plugin needs the Contact Form 7 plugin to be active!', 'cf7-custom-spinner' ); ?></strong><div class="clear"></div></p>
        </div>
        <?php
    ...
    private function show_admin_notice( $notice_number ) {
      ...
      $notices = array(
        ...
        1 => __( 'If you like the Contact Form 7 Custom Spinner plugin please support my work with giving it a good rating so that other users know it is helpful for you. Thanks.', 'cf7-custom-spinner' ) . '<br /><a href="https://wordpress.org/support/plugin/' . $this->_core->get_plugin_slug() . '/reviews/#new-post" title="' . __( 'Please rate plugin', 'cf7-custom-spinner' ) .'"><span class="dashicons dashicons-star-filled"></span><span class="dashicons dashicons-star-filled"></span><span class="dashicons dashicons-star-filled"></span><span class="dashicons dashicons-star-filled"></span><span class="dashicons dashicons-star-filled"></span></a>',
        
        // notice 2 - invite to follow me
        2 => '<strong>' . __( 'Do you like the Contact Form 7 Custom Spinner plugin?', 'cf7-custom-spinner' ) . '</strong><br />' . __( 'Follow me:', 'cf7-custom-spinner' ) . ' <a class="dashicons dashicons-googleplus" href="https://plus.google.com/+petersplugins" title="' . __( 'Authors Google+ Page', 'cf7-custom-spinner' ) . '"></a> <a class="dashicons dashicons-facebook-alt" href="https://www.facebook.com/petersplugins" title="' . __( 'Authors facebook Page', 'cf7-custom-spinner' ) . '"></a>',
        
        // notice 3 - invite to take a look at my other plugins
        3 => '<strong>' . __( 'Do you like the Contact Form 7 Custom Spinner plugin?', 'cf7-custom-spinner' ) . '</strong><br /><a href="https://petersplugins.com/">' . __( 'Take a look at my other plugins', 'cf7-custom-spinner' ) . '</a>'
